...
void gif::GifGetClosestPaletteColor(GifPalette *pPal, int r, int g, int b, int *bestInd, int *bestDiff, int treeRoot) {
...
void gif::GifSplitPalette(uint8_t *image,
                          int numPixels,
                          int firstElt,
                          int lastElt,
                          int splitElt,
...
void gif::GifMakePalette(const uint8_t *lastFrame,
...
void gif::GifDitherImage(const uint8_t *lastFrame,
                         const uint8_t *nextFrame,
                         uint8_t *outFrame,
                         uint32_t width,
                         uint32_t height,
...
void gif::GifThresholdImage(const uint8_t *lastFrame,
                            const uint8_t *nextFrame,
                            uint8_t *outFrame,
                            uint32_t width,
                            uint32_t height,
...
void gif::GifWriteBit(gif::GifBitStatus *stat, uint32_t bit) {
  bit = bit & 1;
...
void gif::GifWriteChunk(std::stringbuf &f, gif::GifBitStatus *stat) {
...
void gif::GifWriteCode(std::stringbuf &f, gif::GifBitStatus *stat, uint32_t code, uint32_t length) {
...
void gif::GifWritePalette(const gif::GifPalette *pPal, std::stringbuf &f) {
...
void gif::GifWriteLzwImage(std::stringbuf &f,
                           uint8_t *image,
                           uint32_t left,
                           uint32_t top,
                           uint32_t width,
...
bool gif::GifBegin(gif::GifWriter *writer,
                   uint32_t width,
                   uint32_t height,
                   uint32_t delay,
                   int32_t bitDepth,
...
bool gif::GifWriteFrame(gif::GifWriter *writer,
                        const uint8_t *image,
                        uint32_t width,
                        uint32_t height,
                        uint32_t delay,
...
bool gif::GifEnd(gif::GifWriter *writer) {
